...
- Git
    ...
    - [전역 gitignore 설정하기](https://gomjellie.github.io/git/2017/06/15/global-git-ignore.html)
...
- Kubernetes, k8s
    ...
    - [Container Runtimes 비교 표](https://great-stone.github.io/container/ContainerRuntimesSheet/)
...
- 파이썬(Python)
    ...
    - [python functools.partial 사용](https://tempdev.tistory.com/36)
    ...
    - [[python] Iterator와 Generator](https://engineer-mole.tistory.com/64)
    - [Python logging json formatter](https://everythingtech.dev/2021/03/python-logging-with-json-formatter/)
    - [[Python] metaclass란](https://brownbears.tistory.com/569)
    ...
    - [Python multiprocessing.Process 멀티프로세싱 1](https://tempdev.tistory.com/26)
    - [Python multiprocessing.Pool 멀티프로세싱 2](https://tempdev.tistory.com/27)
    ...
    - [[python] 파이썬 is와 ==의 차이 (값, 참조)](https://blockdmask.tistory.com/579)
    ...
    - [staticmethod, classmethod, instancemethod 에 대하여](https://hwan-hobby.tistory.com/252)
...
- 긱뉴스 스크랩(GeekNews)
    ...
    - ["확장되지 않는 일"을 통해 이기는 방법](https://news.hada.io/topic?id=17828)
- 깃허브 프로젝트(GitHub)
